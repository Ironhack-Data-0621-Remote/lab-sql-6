...
-- done with import wizard and created a new table film_2020

   -- unfortunatly the following didn't work  
...
-- film_list fields terminated by ',';
...
-- change safe updates in SQLEditor and reconnect

-- update films_2020
-- set rental_duration = 3, rental_rate = 2.99, replacement_cost = 8.99
-- where release_year = '2020' ;

-- check films_2020 update
